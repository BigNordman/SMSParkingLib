package com.nordman.big.smsparkinglib;
...
public abstract class BaseSmsManager {
    ...
    public int appStatus = STATUS_INITIAL;

    protected Context context;
    private BaseGeoManager geoMgr;

    public Date sendDate;
    public Date startParkingDate;

    public String sms = null;
    public String regNum = "";
    public ParkZone currentZone = null;
    public String hours = "1";
    public String statusMessage = "";

    public BaseSmsManager(Context context) {
        this.context = context;
        geoMgr = new BaseGeoManager(context);
    }

    public abstract void updateSms();

    public abstract void showParkingScreen();
